...
class ExpandedEventItem extends StatelessWidget {
  ...
  const ExpandedEventItem({Key key, this.topMargin, this.height, this.isVisible, this.borderRadius, this.title, this.date, this.leftMargin}) : super(key: key);
...
final List<Event> events = [
  Event('steve-johnson.jpeg', 'Toronto Global Design Award 2020', '4.20-30'),
  Event('efe-kurnaz.jpg', 'Studio Bell, home of the National Music Center - Calgary', '4.20-30'),
  Event('rodion-kutsaev.jpeg', 'Le Musée de Saint-Boniface Museum - Winnipeg', '4.28-31'),
];
